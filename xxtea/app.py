...
instanceCaesar = caesarChiper.ChaesarChiper()
...
def encrypt_method():
    if request.headers['Content-Type'] == 'application/json':
        ...
        resultFromEncrypMethod = instanceCaesar.encrypt(varKey, varText)
...
def decrypt_method():
    if request.headers['Content-Type'] == 'application/json':
        ...
        resultFromDecryptMethod = instanceCaesar.decrypt(varKey, varText)
